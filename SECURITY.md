...
30 days for confirmed issues, faster for critical ones. We will credit you in the release notes
...
In scope: the `agentposture` package, its dashboard, API, connectors, container image and GitHub
Action. For how AgentPosture protects the data it holds, and deployment hardening, see
